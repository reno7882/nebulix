...
description: "Nuestras sillas están diseñadas para proporcionar el máximo confort y apoyo"
intro: "Nuestras sillas están diseñadas para proporcionar el máximo confort y apoyo"
hero_template: image
template: full
container: md
hero_buttons:
...
blocks:
  - type: features
    ...
    content: |+
      ## Mobiliario para todo tipo de espacios
  ...
  - type: recentitems
    ...
    post_tag:
      - Docs
    title:  ¡Inspírate con nuestro blog!
    surface: bg-slate-200 text-dark dark:bg-slate-800 dark:text-white
    content: >
      ¿Buscas ideas para crear un espacio de trabajo cómodo y productivo? ¿Quieres estar al día de las últimas tendencias en mobiliario de oficina?
  - type: text_image
    component: TextImage
    container: none
    template: banner
...
Nuestros productos están diseñados para brindarte comodidad y apoyo, para que puedas trabajar cómodamente durante horas. También están fabricados con materiales de alta calidad y con un diseño elegante, para que tu espacio de trabajo sea un lugar inspirador y agradable.
